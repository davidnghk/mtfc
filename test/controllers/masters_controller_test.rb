...
class MastersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create master" do
    assert_difference('Master.count') do
      post masters_url, params: { master: { chi_name: @master.chi_name, code: @master.code, name: @master.name, parent_id: @master.parent_id } }
    end
  ...
  test "should update master" do
    patch master_url(@master), params: { master: { chi_name: @master.chi_name, code: @master.code, name: @master.name, parent_id: @master.parent_id } }
