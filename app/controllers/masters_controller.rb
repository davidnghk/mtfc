class MastersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @master.update(master_params)
        format.html { redirect_to @master.parent, notice: 'Master was successfully updated.' }
  ...
  def destroy
    @master.destroy
    respond_to do |format|
      format.html { redirect_to @master.parent, notice: 'Master was successfully destroyed.' }
  ...
  private
    ...
    def master_params
      params.require(:master).permit(:code, :name, :chi_name, :parent_id, :setting1, 
        :icon, :param_1)
    end
end
